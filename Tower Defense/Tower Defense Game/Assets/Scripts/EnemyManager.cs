...
public class EnemyManager : MonoBehaviour
{
  ...
  public float timeToWaitA = 1; //1
  public float timeToWaitB = 1.5f; //1.5
  public int groupSizeA;
  public int groupSizeB;
  ...
  void Start()
  {
    ...
    Group groupA = new Group(EnemyA, timeToWaitA, groupSizeA); //5
    Group groupB = new Group(EnemyB, timeToWaitB, groupSizeB); //3
